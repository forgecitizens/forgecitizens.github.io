...
class RetroCalendar {
    constructor() {
        ...
        this.predefinedEvents = {
            ...
            '2026-04-10': {
                title: 'Publication sur Vixra de "Fermer la Boucle Ontologique : Mémoire Topologique, Irrévérsibilité Pré-Géométrique et Pourquoi Le Vide Demeure une Frontière Productive"',
                text: 'La flèche du temps est conventionnellement attribuée aux gradients entropiques et aux conditions initiales de basse entropie. Nous soutenons que ce compte rendu est insuffisant. La flèche du temps est l\'expression cumulative de processus irréversibles opérant à toutes les échelles, des fluctuations pré-géométriques qui précèdent le Big Bang jusqu\'à l\'architecture à grande échelle de l\'évolution cosmique. Dans ce cadre, le Big Bang n\'est pas une origine absolue, mais un seuil de transition au sein d\'un régime pré-géométrique plus profond.\n\nL\'état préexistant, qu\'il soit vide ou quasi-vide n\'est pas une absence stable, mais un régime de permissivité maximale. Il génère spontanément des distinctions transitoires, dont la plupart s\'effondrent. Chaque effondrement laisse cependant derrière lui des invariants topologiques : des traces structurelles purement relationnelles qui persistent indépendamment de tout substrat matériel. Par la sélection ontologique qui est une forme de darwinisme pré-biologique les cycles successifs héritent de ces contraintes accumulées, rendant chaque configuration ultérieure plus stable et plus probable que la précédente. Le vide n\'est jamais pleinement annihilé ; il persiste comme une frontière active et productive, perpétuellement contrebalancée par la mémoire topologique des distinctions antérieures.\n\nCet article montre que la première distinction elle-même émerge d\'une nécessité logique, une boucle auto-référentielle minimale au sein de la pure indifférenciation  et que cette même logique sélective est auto-similaire à travers les échelles, se manifestant jusque dans la robustesse extraordinaire des extrémophiles et, en mathématiques, comme le sédiment le plus stable de la sélection ontologique. La complexité ne défait pas le vide ; elle le transforme en la condition de possibilité même de toute structure ultérieure. L\'irréversibilité, la mémoire et la sélection ontologique opèrent ainsi comme des principes unifiés, fermant une boucle ontologique dans laquelle la flèche du temps et les formes intemporelles des mathématiques constituent les deux invariants universels de toute réalité ayant jamais émergé du vide.',
                link: null,
                linkText: null
            },
            '2026-05-16': {
                title: 'Release v1 de Consoscope',
                text: 'Consoscope est un simulateur de crédit à la consommation gratuit et évidemment sans inscription. L\'objectif est de permettre à tout un chacun de comprendre les mécanismes du crédit à la consommation, de visualiser le montant réel des mensualités qui seront débitées via des graphiques mais aussi de calculer la mensualité réelle.\n\nVous pouvez, par exemple, copier/coller le texte de proposition de crédit qu\'une banque vous fait et Consoscope remplira automatiquement les champs adéquats. Ne vous faites plus avoir par les frais cachés écrits en tout petits caractères ou par les phrases sans queue ni tête !',
                link: 'https://www.forgecitizens.com/consoscope.html',
                linkText: 'Accéder à Consoscope'
            }
        };
